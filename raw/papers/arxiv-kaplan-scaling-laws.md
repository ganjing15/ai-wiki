# arXiv: Scaling Laws for Neural Language Models (Kaplan et al.)
...
## Authors
Jared Kaplan, Sam McCandlish, Tom Henighan, Tom B. Brown, Benjamin Chess, Rewon Child, Scott Gray, Alec Radford, Jeffrey Wu, Dario Amodei. (OpenAI per context.)
